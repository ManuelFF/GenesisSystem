...
import NMOC.MD_Mantenimientos.IC.MICROCON_MantenerProductos;
 ...
 * @author USUARIO
 */
public class JIFMantenerProductos extends javax.swing.JInternalFrame 
{

    /**
     * Creates new form JIFMantenerProductos
     */
    
    MICROCON_MantenerProductos PROcon = new MICROCON_MantenerProductos();
    LOG lc = new LOG();
    ...
    public JIFMantenerProductos() 
    {
        ...
        trsFiltro = new TableRowSorter(JTProducto.getModel());
        
        //ESTABLECIENDO EL ROW FILTER SORTER
        JTProducto.setRowSorter(trsFiltro);
    ...
    private void initComponents() {
        ...
        jLabel4.setText("MANTENIMIENTO PRODUCTOS");
